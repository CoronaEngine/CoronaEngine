/** Compatibility facade for Blockly and role-script runtime operations. */

import { editorApi } from '../api/editorApi.js';

export const scriptingService = {
  executePythonCode: (code, mode, sceneName, actorName, targetType = 'actor') => editorApi.scratch.executePythonCode(code, mode, sceneName, actorName, targetType),
  ...
  sendKeyEvent: (key, modifiers, displayKey) => editorApi.scratch.sendKeyEvent(key, modifiers, displayKey),
  sendKeyUpEvent: (key, displayKey) => editorApi.scratch.sendKeyUpEvent(key, displayKey),
  sendMouseEvent: (eventType, button, x, y, viewportX, viewportY, viewportWidth, viewportHeight, pickedActor = '') => editorApi.scratch.sendMouseEvent(eventType, button, x, y, viewportX, viewportY, viewportWidth, viewportHeight, pickedActor),
};
