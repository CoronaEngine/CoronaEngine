/**
 * Compatibility facade for legacy Dock, panel-window, and process commands.
 *
 * The C++ manifest contract remains owned by `src/api/editorApi.js`.
 */
...
export const appService = {
  ...
  // Create a panel that is born directly as its own borderless OS window.
