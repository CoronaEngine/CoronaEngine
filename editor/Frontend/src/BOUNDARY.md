...
| `utils/` | active adapter | 低延迟输入和视口辅助；见 [`utils/BOUNDARY.md`](utils/BOUNDARY.md) | 见 [`utils/BOUNDARY.md`](utils/BOUNDARY.md) |
...
- 外部旧宿主 bridge 已删除；transport 和 service 实现分别归 `api/` 与 `services/`，
  不得在 Vue 业务中复制旧协议；
